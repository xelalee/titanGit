...
public class EmailUtil {
	...
	public static void main(String[] args){
		...
		email = new EmailUtil("smtp.gmail.com", 587, EncryptionTypes.TLS.ordinal(), true, "glq0316@gmail.com",password,true);
		col = new ArrayList();
		col.add("d:/xx.txt");
		try{
			email.sendEmail(
					"glq0316@gmail.com",
					"test mail: 587",
					"jacky.gu@titan-arc.com",
					"test mail subject",
					"<html><body><font color='red'>can you see?中国</font></body></html>",
					col);
			System.out.println("send out 3");
		}catch(Exception ex){
			ex.printStackTrace();
			System.out.println("not send out 3");
		}	
		
		email = new EmailUtil("smtp.gmail.com", 465, EncryptionTypes.SSL.ordinal(), true, "glq0316@gmail.com",password,true);
		col = new ArrayList();
		col.add("d:/xx.txt");
		try{
			email.sendEmail(
					...
					"<html><body><font color='red'>can you see?中国</font></body></html>",
					col);
			System.out.println("send out 4");
		}catch(Exception ex){
			ex.printStackTrace();
			System.out.println("not send out 4");
		}
