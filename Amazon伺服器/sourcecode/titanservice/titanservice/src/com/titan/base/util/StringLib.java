...
public class StringLib
{
    ...
    static public int ignoreCaseIndexOf(String searchStr, String str, int fromIndex)
    {
        ...
        str.toLowerCase().getChars(0, len2, strLower, 0);

        char strUpper[] = new char[len2];
        str.toUpperCase().getChars(0, len2, strUpper, 0);
    ...
    static public int ignoreCaseIndexOfWithDelimiter(String searchStr, String str, int fromIndex, char delimiter[])
    {
    	if (searchStr == null || searchStr.length() == 0 || str == null || str.length() == 0) return -1;
    ...
    static public boolean ignoreCaseStartsWith(String searchStr, String str, int fromIndex)
    {
     ...
     */
    static public String unlimitedNumberAddDec(String s, int value) throws NumberFormatException
    {
		// (1)
