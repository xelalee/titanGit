...
<form name="formAccount" method="post" action="">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="content3">
    ...
    <tr>
        ...
        <td class="title_bar2">&nbsp;&nbsp;&nbsp;Add Admin Account <br>
        </td>
    </tr>    
    <tr>
        <td height="27">&nbsp;</td>
      ...
      <td valign="top">
          ...
          <tr bordercolor="#FFFFFF" bgcolor="#F5F9FA">
            ...
            <td valign="top" width="65%"> 
                <input class="content3" id="username" name="username" size="30" maxlength="20" value=""  >      
            </td>
          </tr>
          <tr bordercolor="#FFFFFF" bgcolor="#F5F9FA">
            <td bgcolor="#CCCCCC"><span class="star">* </span> <span class="content3">Password</span></td>
            <td><input class="content3" name="password" type="password" value="" size="30" maxlength="20"></td>
          </tr>         
          <tr bordercolor="#FFFFFF" bgcolor="#F5F9FA">
            <td bgcolor="#CCCCCC"><span class="star">* </span><span class="content3">Confirm Password</span></td>
            <td><input class="content3" name="password1" type="password" value="" size="30" maxlength="20"></td>
          </tr>
          <tr bordercolor="#FFFFFF" bgcolor="#F5F9FA">
            <td bgcolor="#CCCCCC"><span class="star">* </span><span class="content3">Email</span></td>
            <td colspan="2" valign="top"> 
                <input class="content3" id="email" name="email" size="30" maxlength="50" value="">
            </td>
          </tr>         
          <tr bordercolor="#FFFFFF" bgcolor="#F5F9FA">
...
function toSubmit() {  
	  ...
	  if(err_message != '') {
	     ...
	     document.formAccount.action = '<%= rootDirectory %>/controller?action=AdministratorAction&dispatch=add';
...
function checkField() {
  ...
  var username = document.formAccount.username.value;
  ...
  if(username == "") {
     ...
     message = "Username length is at least 6.\n";
  }
...
inputUser.onkeyup = filterEmailUserInput;
