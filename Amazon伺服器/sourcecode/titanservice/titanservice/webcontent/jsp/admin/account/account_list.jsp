...
<%
	...
	PaginateController controller = new PaginateController(request, response, AdministratorDAO.getInstance().getAllSQL());
...
<%
                   ...
                   AdministratorBean account = new AdministratorBean(hm);
%>
                   <display:column title = "Username"><a href="<%=rootDirectory%>/jsp/admin/account/account_edit.jsf?username=<%=account.getUsername()%>" ><%=account.getUsername()%></a></display:column>
                   <display:column title = "Email"><%=account.getEmail()%></display:column>
                   <display:column title = "Group"><%=account.getGroup_name()%></display:column>
...
function toAdd() {
	location.href="<%=rootDirectory%>/jsp/admin/account/account_add.jsf";
}
