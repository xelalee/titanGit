...
<%
    ...
    GroupBean group = GroupDAO.getInstance().get(group_id);
%>
...
<input type='hidden' name='function_ids' >
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="content3">
    ...
    <tr>
        ...
        <td class="title_bar2">&nbsp;&nbsp;&nbsp;Edit Group <br>
        </td>
    </tr>    
    <tr>
        <td height="27">&nbsp;</td>
      ...
      <td valign="top">
          ...
          <tr bordercolor="#FFFFFF" bgcolor="#F5F9FA">
            ...
            <td valign="top" width="75%"> 
                <input class="content3" id="group_name" name="group_name" size="30" maxlength="20" value="<%=group.getGroup_name() %>"  >      
            </td>
          </tr>        
          <tr bordercolor="#FFFFFF" bgcolor="#F5F9FA">
           	  ...
           	  <%
   	            ...
   	            for(FunctionBean function: functions){
   	            	...
   	            	if(!function.getMenu_name().equals(previous)){
		           	  ...
		           	  <tr>
		           	  <td width="40%"></td>
		           	  <td width="60%"><%=function.getFunction_name() %>&nbsp;<input type=checkbox name="check_function" value="<%=function_id%>" <%=group.getFunctions().contains(function_id)?"checked":"" %>></td>
		           	  </tr>
		           	  <%
           	  }
           	  %>            
...
function toSubmit() {  
	  ...
	  if(err_message != '') {
	     ...
	     document.formGroup.action = '<%= rootDirectory %>/controller?action=GroupAction&dispatch=edit';
...
function toDelete() {  
	if (confirm("Do you want to delete this group?")){	
	    document.formGroup.action = "<%= rootDirectory %>/controller?action=GroupAction&dispatch=delete";
	    document.formGroup.submit();
	}
