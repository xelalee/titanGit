...
<html>
<head>
<title><h:outputText value="#{bundle.SESSION_KICKOFF_TITLE}" /></title>
</head>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td width="559">
      <span class="title1">
        <h:outputText value="#{bundle.SESSION_KICKOFF_TITLE}" />
      </span>
      <br> 
  ...
  <tr> 
    ...
    <td valign="top"> 
        <span class="content1">
        <h:outputText value="#{bundle.SESSION_KICKOFF_INFO}" escape="false" />
