...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  <tr> 
    ...
    <td colspan="2" rowspan="2" valign="top">
        <span class="content2"><h:outputText value="#{bundle.MY_ACCOUNT}"/> /</span> 
        <span class="title0"><h:outputText value="#{bundle.PERSONAL_INFORMATION}"/></span><br><br>
        <span class="title1"><h:outputText value="#{bundle.ACCOUNT_UPDATE_SUCCESS}" /></span><br>
  ...
  <tr> 
    ...
    <td width="22"><div align="center"></div></td>
      ...
      <h:outputText value="#{bundle.ACCOUNT_UPDATE_CONFIRM}" />
      <br>
          </span><br>
          <br>
          </p>
      <p>
           <h:commandButton styleClass="button" value="#{bundle_button.CONTINUE}" action="#{LoginAction.loadWelcomeAction}"></h:commandButton>
      </p>
      </td>
  </tr>
  <tr> 
