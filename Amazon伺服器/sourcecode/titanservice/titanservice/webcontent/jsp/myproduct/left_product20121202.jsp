...
<f:loadBundle basename="com.titan.mytitan.product.bundles.Resources" var="bundle_left"/>
...
<table width="190" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr bgcolor="#F2F2F2"> 
    ...
    <td width="152" height="27" valign="top">
		...
		<h:commandLink action="myproduct_list" value="#{bundle_left.PRODUCT_REGISTRATION}">
		</h:commandLink>    	
    	<br>
		</font>
		</p>
