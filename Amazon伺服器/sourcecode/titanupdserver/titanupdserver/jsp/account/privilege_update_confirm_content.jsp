...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  <tr> 
    ...
    <td colspan="2" rowspan="2" valign="top">
      <br>
        <span class="content2">Privilege Management /</span> <span class="title0">Account</span><br>
      <br>
        <span class="title1">Update Success</span><br>
  ...
  <tr> 
    ...
    <td width="22"><div align="center"></div></td>
      <td width="471" valign="top"> <p><span class="content2">Your privilege information 
...
<!--
function toContinue(){
	lcation.href="<%=rootDirectory%>/jsp/account/privilege.jsp";
}
//-->
</script>
