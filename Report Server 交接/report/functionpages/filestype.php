...
<html>
    <head>
        ...
        <script>
            ...
            function connectcolum(obj, device, tablename)
            {
                $.ajax({
                    type: "POST",
            ...
            <div id="container">
                <table>
                    ...
                    <td id="table" style="border:#002DFF solid 1px; vertical-align:top">
                        <div id="datadiv">
                            <div><a>首頁&nbsp;&nbsp;>>&nbsp;&nbsp;網路狀態&nbsp;&nbsp;>>&nbsp;&nbsp;<font style="color: red">檔案形態</font></a></div><br>
                            <div id="tabs">
                                <ul>
                                    <?php
                                    ...
                                    while ($devicerows = mysql_fetch_array($deviceresult)) {
                                        $rowscount++;
                                        echo '<li><a href="filestype_detail.php?rowscount=' . $rowscount . '&devicerows=' . $devicerows[1] . '">Device-' . $rowscount . '</a></li>';
                                    }
                                    ?>
                                </ul>
                            </div>
