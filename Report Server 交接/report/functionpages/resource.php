...
<div id="menudiv">
                    ...
                    <td id="table" style="border:#002DFF solid 1px; vertical-align:top">
                        <div id="datadiv">
                            <div id="tabs">
                                <div><a>首頁&nbsp;&nbsp;>>&nbsp;&nbsp;網路狀態&nbsp;&nbsp;>>&nbsp;&nbsp;<font style="color: red">可用資源</font></a></div><br>
                                ...
                                <ul>
                                    ...
                                    while ($devicerows = mysql_fetch_array($deviceresult)) {
                                        $rowscount++;
                                        echo '<li><a href="resource_detail.php?rowscount=' . $rowscount . '&devicerows=' . $devicerows[1] . '">Device-' . $rowscount . '</a></li>';
                                    }
                                    ?>
                                </ul>
                            </div>
