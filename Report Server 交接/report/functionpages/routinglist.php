            ...
            <div id="container">
                <table>
                    ...
                    <td id="table" style="border:#002DFF solid 1px; vertical-align:top">
                        <div id="datadiv">
                            <div id="tabs">
                                <div><a>首頁&nbsp;&nbsp;>>&nbsp;&nbsp;網路狀態&nbsp;&nbsp;>>&nbsp;&nbsp;<font style="color: red">顯示路由列表</font></a></div><br>
                                ...
                                <ul>
                                    ...
                                    while ($devicerows = mysql_fetch_array($deviceresult)) {
                                        $rowscount++;
                                        echo '<li><a href="routinglist_detail.php?device=">Device-' . $rowscount . '</a></li>';
                                        //echo '<li><a href="routinglist_detail.php?device=' . $rowscount . '&devicerows=' . $devicerows[1] . '">Device-' . $rowscount . '</a></li>';
                                    }
                                    ?>
                                </ul>
                            </div>
