                    ...
                    <td id="menu" style="border: solid 1px red">
                        <div id="menudiv">
                            ...
                            <div>
                                ...
                                <a href="userstatus.php"><font size="2">使用者狀態</font></a><br/>
                            </div>
                            <h1>VPN狀態</h1>
                            <div>
                            ...
                            <div id="tabs">
                                ...
                                <ul>
                                    ...
                                    while ($devicerows = mysql_fetch_array($deviceresult)) {
                                        $rowscount++;
                                        echo '<li><a href="userstatus_detail.php?rowscount=' . $rowscount . '&devicerows=' . $devicerows[1] . '">Device-' . $rowscount . '</a></li>';
                                    }
                                    ?>
                                </ul>
                            </div>
